 ...
 *  - Queue<Reserva>  (cola FIFO) -> Opciones 2 y 3: Reservar / Confirmar compra
 *  - char[][] dentro de Sala     -> Opcion 2: Matriz de asientos
 */
public class Controlador {

    private final ArbolPeliculas cartelera    = new ArbolPeliculas();
    private final Queue<Reserva> colaReservas = new LinkedList<>();
    ...
    public Queue<Reserva> obtenerColaReservas() { return colaReservas; }

    public boolean hayReservasPendientes() { return !colaReservas.isEmpty(); }
